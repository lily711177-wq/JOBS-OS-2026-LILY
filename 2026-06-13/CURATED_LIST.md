# CURATED JOB LIST — 2026-06-13
## JOBS OS Lily Edition — EASY MODE (re-run with profile context)
### Student: Lily | KPU Surrey | BSc Math (Education conc.) | Burnaby-based | ADHD-aware filtering

**Your current job:** KPU Peer Tutor Level 2 (already secured — keep this!)
**What works for you:** Structured, predictable environments. Math/teaching roles. Simple cashier roles. Avoid: fast food, complex menus, high-speed assembly.
**Best locations:** KPU Surrey (campus), Burnaby (home), transit-accessible ≤45 min
...
### NEXT STEP
Pick a job (say the # or name) → I'll `SHOOT` a full package: tailored resume + cover letter + interview prep for that specific role.
